...
Si quieres, puedo:
- añadir un *checklist* en un archivo `CHECKLIST.md`,
- o añadir una acción adicional que comente en el PR con el estado del deploy (opcional).

_Pregunta:_ ¿quieres que haga además el `CHECKLIST.md` y un commit que incluya capturas/plantillas listas para la entrega?